<template>
  <div>
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h1 class="h2 mb-0">Edit Scope</h1>
    ...
    <div v-if="scopeStore.loading && !form.id" class="text-center py-5">
      <div class="spinner-border text-primary" role="status">
        <span class="visually-hidden">Loading...</span>
      </div>
      <p class="mt-2">Loading scope data...</p>
    </div>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input 
                  ...
                  v-model="form.name" 
                  required
                  placeholder="e.g., read:users, write:roles, etc."
                >
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <textarea 
                  ...
                  rows="3"
                  required
                  placeholder="Describe the purpose and permissions of this scope"
                ></textarea>
            ...
            <div class="col-12 mb-3 mt-4">
              ...
              <p class="text-muted small">Select the permissions that will be granted by this scope.</p>
...
// Get scope ID from route params
...
onMounted(async () => {
  try {
    const scopeData = await scopeStore.fetchScopeById(scopeId)
    
    // Populate form
    form.id = scopeData.id;
    form.name = scopeData.name;
    form.description = scopeData.description;
    if (scopeData.permissions) {
      form.permissions = scopeData.permissions.map(p => p.name);
    }
  } catch (error) {
